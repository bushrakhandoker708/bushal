...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'bKash payment shopping',
    'premium products Dhaka',
    'Bushra Khandoker',
    'curated goods Bangladesh',
    'fast delivery e-commerce BD'
  ],
  ...
  openGraph: {
    ...
    images: [
      { 
        ...
        width: 1200, 
        height: 630, 
        alt: 'Bushal E-commerce Platform - Premium Products in Bangladesh' 
      }
    ],
  },
  twitter: {
    ...
    images: ['/og-image.png'],
    creator: '@BushalBD', // Replace with actual Twitter handle if available
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: { 
    canonical: 'https://bushal.vercel.app' 
  },
}
...
const organizationJsonLd = {
  ...
  founder: { 
    ...
    url: 'https://github.com/Bushraabir' 
  },
  sameAs: [
    'https://github.com/Bushraabir/bushal',
    // Add Facebook, Instagram, or LinkedIn URLs here when available
  ],
  contactPoint: {
    '@type': 'ContactPoint',
...
// Global JSON-LD for Sitelinks Searchbox (Helps Google show a search bar under your site in results)
const websiteJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'WebSite',
  name: 'Bushal',
  ...
  potentialAction: {
    ...
    target: { 
      '@type': 'EntryPoint', 
      urlTemplate: 'https://bushal.vercel.app/dashboard?q={search_term_string}' 
    },
