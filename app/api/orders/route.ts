...
export async function POST(request: Request) {
  ...
  // Fetch complete order items with product details for the email template
  ...
  // Fetch customer profile for the email
  ...
  // Fire-and-forget email notification (don't block order success response)
  sendAdminOrderNotification({
    ...
    items: emailItems,
    address: null, // Legacy string format used in this flow
