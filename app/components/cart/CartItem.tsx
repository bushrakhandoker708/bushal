      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-3">
          <button
            ...
            className="w-7 h-7 rounded-lg border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition-colors font-medium"
          >
            −
          </button>
